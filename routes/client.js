    ...
    async (req, res) =>
    {
        ...
        (
            (case_details) =>
            {
                ...
                const {_id, case_name, case_type, case_descp, lawyer_id, court_case_no, court_type, h_date, isResolved} = case_details[0];

                res.render('display_case_details', {_id, user_type, case_name, case_type, case_descp, lawyer_id, court_case_no, court_type, h_date, isResolved});
            }
        ).catch
        (
            (err) => console.log(err)
